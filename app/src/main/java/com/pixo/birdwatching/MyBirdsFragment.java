...
public class MyBirdsFragment extends Fragment {

	ListView listView;
	TextView messageTextView;

	public MyBirdsFragment() {}
...
//		String userId = "R1Glshh60uUtURSQm2NxakiHpGV2";

		MyBirdsFragment.ReadTask task = new MyBirdsFragment.ReadTask();
		task.execute("http://birdobservationservice.azurewebsites.net/Service1.svc/observations?userid=" + userId);
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		return inflater.inflate(R.layout.my_birds_fragment, container, false);
	}

	@Override
	public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
		listView = getView().findViewById(R.id.my_observations_listview);
